...
class Model(object):
    def __init__(self, opt, test_no_mask, test_add):
        ...
        if test_no_mask == True:
            self.save_root = f"./result_test/{opt.model_name}_{opt.backbone_name}_test_no_mask"
        else:
...
model_name_list = ['RB_VIT', 'RB_VIT_dir', 'RB_VIT_dir_no_ref','VIT_dir', 'RB_VIT_average', 'RB_VIT_dir_mask25', 'RB_VIT_dir_mask50', 'RB_VIT_dir_mask75', 'ST_VIT', 'RB_VIT_Res', 'RB_VIT_dir_no_ref',
...
if __name__ == '__main__':
    ...
    for classname in MVTec_CLASS_NAMES:
        ...
        # opt.resume = fr'result/RB_VIT_dir_WideResnet50_k=4/weight/{opt.class_name}'
        opt.resume = r'result/RB_VIT_dir_WideResnet50/weight/transistor'
        # if test_no_mask == True:
